...
function ptm_quick_edit() {
	...
	$( '#bulk-edit' )
		...
		.append(
			$('#bulk-edit #ptm_bulk_edit' )
		);

	$( '.inline-edit-row' ).not( '#bulk-edit' )
		.find( '.inline-edit-col-right .inline-edit-col' )
		.append(
			$( '.inline-edit-row #ptm_quick_edit' )
		);
	...
	inlineEditPost.edit = function( id ) {
		...
		$( 'select[name="ptm_post_type"] option[value="' + post_type + '"]', edit_row ).attr( 'selected', 'selected' );
	};
}
